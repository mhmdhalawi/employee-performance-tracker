...
def build_analysis_response(
    ...
    employee_results = [
        EmployeeKpiScores(
            ...
            campaign=employee_by_id[kpi.employee_id].campaign,
            queue=employee_by_id[kpi.employee_id].queue,
            shift=employee_by_id[kpi.employee_id].shift,
            supervisor=employee_by_id[kpi.employee_id].supervisor,
            location=employee_by_id[kpi.employee_id].location,
    ...
    return AnalysisResponse(
        ...
        applied_filters=AnalysisFilters(
            ...
            location=location,
            start_date=selected_start_date or effective_start or overview.date_start,
            end_date=selected_end_date or effective_end or overview.date_end,
            score_period_start_date=score_period_start_date,
            score_period_end_date=score_period_end_date,
