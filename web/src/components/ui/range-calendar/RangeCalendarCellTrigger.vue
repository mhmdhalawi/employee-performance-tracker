...
<template>
  <RangeCalendarCellTrigger
    ...
    :class="cn(
      ...
      'size-8 p-0 font-normal data-[selected]:opacity-100 [&[data-selected]:not([data-selection-start]):not([data-selection-end])]:text-secondary-foreground',
      '[&[data-today]:not([data-selected])]:ring-1 [&[data-today]:not([data-selected])]:ring-primary/40',
      // Selection Start
